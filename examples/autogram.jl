...
# initial solution (6aa61f9 [1]) implements this, however it did not finish.  Initially I
...
# iniitial state doesn't seem to do much (13f2a62 [2]).
#
...
#
# Note that there is not necessarily one answer for any given
#
# This was ported from SpelledOut.jl [3].
#
# References:
...
#
# Links:
#   - [1]: github.com/jakewilliami/SpelledOut.jl/commit/6aa61f9
...
# But it should be a pangram because it should contain all letters in the alphabet.
